...
int yaksa_get_size(yaksa_type_t type, uintptr_t * size)
{
...
int yaksa_get_extent(yaksa_type_t type, intptr_t * lb, uintptr_t * extent)
{
    yaksi_type_s *yaksi_type;
    int rc = YAKSA_SUCCESS;
...
int yaksa_get_true_extent(yaksa_type_t type, intptr_t * lb, uintptr_t * extent)
{
    yaksi_type_s *yaksi_type;
    int rc = YAKSA_SUCCESS;
