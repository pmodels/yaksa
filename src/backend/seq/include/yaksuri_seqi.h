...
typedef struct yaksuri_seqi_type_s {
    int (*pack) (const void *inbuf, void *outbuf, uintptr_t count, yaksi_type_s * type, yaksa_op_t op);
    int (*unpack) (const void *inbuf, void *outbuf, uintptr_t count, yaksi_type_s * type, yaksa_op_t op);
} yaksuri_seqi_type_s;
